...
// Fetch Products
$query = "SELECT * FROM product WHERE type = 'drink'";
$result = mysqli_query($con, $query);

// Fetch Categories for Filter
$categoriesQuery = "SELECT DISTINCT category FROM product WHERE type = 'drink'";
...
<header>
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li><a href="menu.php">Reservation</a></li>
...
<section class="section menu" aria-label="menu-label" id="menu">
    <div class="container">
        ...
        <div class="category-filter">
            <select class="category-select" onchange="filterMenu(this.value)">
        ...
        <ul class="grid-list" id="menu-items">
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <li class="menu-item" data-category="<?php echo $row['category']; ?>">
