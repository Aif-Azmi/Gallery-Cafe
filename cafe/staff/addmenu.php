...
<head>
    ...
    <style>
    body {
        background-image: url('img/menub.jfif');
    ...
    .glass-effect {
        ...
        padding: 20px;
        color: #fff;
        /* Ensure text color within glass effect is white */
    }
    ...
    .product-table td {
        ...
        text-align: left;
        color: #fff;
        /* Change table text color to white */
    }

    .product-table th {
        background-color: rgba(0, 0, 0, 0.7);
        /* Darken header background for contrast */
        font-weight: bold;
    }

    .product-table tr:nth-child(even) {
        background-color: rgba(255, 255, 255, 0.2);
        /* Semi-transparent background for even rows */
    }

    .product-table tr:nth-child(odd) {
        background-color: rgba(255, 255, 255, 0.1);
        /* Slightly different semi-transparent background for odd rows */
    }
            ...
            <table class="product-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="updateitem.php" method="get" style="display:inline;">
